                    ...
                    <div class="menu">
                        <ul>
                           <li><a href="index.php"><i class="fas fa-home"></i> Dashboard</a></li>
                            ...
                            <li><a href="all-constructions.php"><i class="fa fa-users"></i>Constructions</a></li>
                            <li><a href="all-team.php"><i class="fa fa-users"></i>Our Team</a></li>
                            <li><a href="all-project.php"><i class="fa fa-images"></i>Project</a></li>
                            <li><a href="all-testimonial.php"><i class="fa fa-images"></i>Testimonial</a></li>
                             <?php  } ?>
