...
$update="UPDATE teams SET team_name='$name',team_designation='$desig' WHERE team_id='$id'";
  ...
  if(!empty($desig)){
       if(mysqli_query($con,$update)){ 
        ...
        if($image['name']!=''){
          ...
          header('location: view-constructions.php?vt='.$id);
          }else{
            echo"User constructions imge update failed.";
          }
      ...
      echo "Opps! User constructions information update failed.";
       }
                ...
                <div class="card-header">
                  <div class="row">
                      ...
                      <div class="col-md-4 card_button_part">
                          <a href="all-constructions.php" class="btn btn-sm btn-dark"><i class="fas fa-th"></i>All Team</a>
                      </div>  
                  </div>
                </div>
                <div class="card-body">
